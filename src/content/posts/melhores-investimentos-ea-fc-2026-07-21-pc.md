---
author: "FutQuant"
pubDatetime: 2026-07-21T22:29:18.000Z
...
faq:
  - q: "Qual a melhor carta para investir hoje (21/07/2026) no EA FC?"
    a: "Alessandro Nesta (89, Icons) lidera, com +25.2% em 7 dias a 84k coins no PC. A lista mede momentum e deve ser confirmada com uma cotação atual antes da compra."
...
> 🔝 **Destaque:** Alessandro Nesta (89) acumula **+25.2% em 7 dias** a 84k coins; leitura atual: **momentum moderado**.
...
- A mediana é de **+14.0% em 24h** e **+16.0% em 7 dias**.
...
| --- | --- | --- | --- | --- | --- | --- |
| Alessandro Nesta | 89 | Icons | 84k coins | +15.8% | +25.2% | Momentum moderado |
| Daniele De Rossi | 89 | Serie A TIM | 199k coins | +7.9% | +18.4% | Momentum moderado |
| Ilario Monterisi | 84 | Serie BKT | 45k coins | +31.2% | +16% | Esticada |
| Francesco Totti | 89 | Icons | 199k coins | +7.9% | +13.3% | Momentum moderado |
| Giorgio Scalvini | 86 | Serie A TIM | 49k coins | +14% | +8.9% | Momentum moderado |


## 📈 Análise dos destaques

- **Alessandro Nesta (89)** — 84k coins, **+25.2% em 7 dias** (+15.8% em 24h). Preço em linha com a média de 7 dias (-4%). Sem previsão recente válida; acompanhe preço e liquidez para escolher a entrada.

- **Daniele De Rossi (89)** — 199k coins, **+18.4% em 7 dias** (+7.9% em 24h). Preço +14% acima da média de 7 dias (aquecida). Sem previsão recente válida; acompanhe preço e liquidez para escolher a entrada.

- **Ilario Monterisi (84)** — 45k coins, **+16% em 7 dias** (+31.2% em 24h). Preço +11% acima da média de 7 dias (aquecida). Sem previsão recente válida; acompanhe preço e liquidez para escolher a entrada.

- **Francesco Totti (89)** — 199k coins, **+13.3% em 7 dias** (+7.9% em 24h). Preço em linha com a média de 7 dias (-5%). Sem previsão recente válida; acompanhe preço e liquidez para escolher a entrada.

- **Giorgio Scalvini (86)** — 49k coins, **+8.9% em 7 dias** (+14% em 24h). Preço +13% acima da média de 7 dias (aquecida). Sem previsão recente válida; acompanhe preço e liquidez para escolher a entrada.
...
Alessandro Nesta (89, Icons) lidera, com +25.2% em 7 dias a 84k coins no PC. A lista mede momentum e deve ser confirmada com uma cotação atual antes da compra.
...
- [Mercado EA FC em 21/07: Italianos — PC](/posts/mercado-ea-fc-2026-07-21-pc/)
